...
impl Piece {
    ...
    pub fn to_string(&self) -> String {
        // A simplified implementation - would need to be expanded
        match self.p {
            constants::ERROR => "Error".to_string(),
            _ => format!("Piece({})", self.p)
        }
    }
    ...
    pub fn from_wind(wind: u8) -> Self {
        ...
        match wind {
            0 => Self { p: constants::EAST_WIND },
            1 => Self { p: constants::SOUTH_WIND },
            2 => Self { p: constants::WEST_WIND },
            3 => Self { p: constants::NORTH_WIND },
            _ => Self { p: constants::ERROR },
        }
    }
